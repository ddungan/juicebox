...
async function createInitialUsers() {
    try {
      ...
      await createUser({ username: 'sandra', password: '2sandy4me', name: 'Just Sandra', location: 'Nope' });
      await createUser({ username: 'glamgal', password: 'soglam', name: 'Joshua', location: 'UES NYC' });
...
async function createInitialPosts() {
    try {
      ...
      await createPost({
        ...
        content: "This is my first post. I hope I love writing blogs as much as I love writing them."
        tags: ["#happy", "#youcannotdoanything"]
      });
      await createPost({
        authorId: glamgal.id,
        title: "Glam Gal's First Post",
        content: "This is my first post. I hope I love writing blogs as much as I love writing them."
        tags: ["#happy", "#youcandoanything", "#yadayada"]
      });
